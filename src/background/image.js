...
export const LANDSCAPE_IMAGES = [
  ...
  "https://i.natgeofe.com/n/d69d750c-47ef-4356-a18c-c40955cc9f5f/085bde09_63da_46f9_8a7b-599bc8168b5f.jpg",
...
/**
 * Get a random landscape image URL
 */
...
export async function getRandomPreloadedImage() {
  ...
  for (let i = 0; i < maxAttempts; i++) {
    ...
    try {
      ...
      log(`Failed to load image: ${imageUrl} — ${error.message}`);
    }
  }
